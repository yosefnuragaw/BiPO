...
class ScriptArguments:
    ...
    #EXP
    quantile: Optional[float] = field(default=0.9, metadata={"help": "top quantile"})
    modifier: Optional[float] = field(default=0., metadata={"help": ""})
